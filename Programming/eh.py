...
self.colour = (random.randrange(0, 255), random.randrange(0, 255),
random.randrange(0, 255))
def draw(self,screen):
pygame.draw.rect(screen, self.colour, [self.x, self.y, self.height,
self.width], 0)
def move(self):
self.x += self.xvel
self.y += self.yvel
...
def draw(self, screen):
pygame.draw.ellipse(screen, self.colour,[self.x, self.y, self.height,
self.width], 0 )
def move(self):
self.x += self.xvel
self.y += self.yvel
